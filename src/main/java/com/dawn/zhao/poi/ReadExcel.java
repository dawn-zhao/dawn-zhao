package com.dawn.zhao.poi;

import com.alibaba.fastjson.JSONObject;
import com.dawn.zhao.utils.apivalidate.MD5;
...
public class ReadExcel {
    ...
    public static List<String[]> readExcel() throws IOException{
        //检查文件
        Workbook workbook = getWorkBook(new FileInputStream(new File("C:\\Users\\76456\\Desktop\\欧珀莱2万会员.xlsx")));
            ...
            for(int sheetNum = 0;sheetNum < workbook.getNumberOfSheets();sheetNum++){
                ...
                for(int rowNum = firstRowNum+1;rowNum <= lastRowNum;rowNum++){ //为了过滤到第一行因为我的第一行是数据库的列
                    ...
                    for(int cellNum = firstCellNum; cellNum < lastCellNum;cellNum++){
                        ...
                        cells[cellNum] = MD5.getMD5(getCellValue(cell));
                    }
                    list.add(cells);
                }
            }
