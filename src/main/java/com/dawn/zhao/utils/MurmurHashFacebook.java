...
@ThreadSafe
public class MurmurHashFacebook {
    ...
    public MurmurHashFacebook(long seed) {
        this.seed = seed;
    }
     ...
     * @return
     */
    public static MurmurHashFacebook createRepeatableHasher() {
        return new MurmurHashFacebook(JCOMMON_SEED);
    }
