//package com.dawn.zhao.image_utils;
//
...
//            // 从流里将图片写入缓冲图片区
//            src = ImageIO.read(is);
//            result[0] =src.getWidth(null); // 得到w源图片宽
...
//
//        String srcDir = "C://WorkSpace//web//qipai//前台//static//home.jpg";
//        String distDir = "C://WorkSpace//web//qipai//前台//static//home_100.jpg";
//
//        File srcfile = new File(srcDir);
//        File distfile = new File(distDir);
//
//        System.out.println("压缩前图片大小：" + srcfile.length());
//        reduceImg(srcDir, distDir, 100, 100, null);
